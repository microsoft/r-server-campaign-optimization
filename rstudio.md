...
<ul><li>On the VM deployed using the 'Deploy to Azure' button on the <a href="START_HERE.md">Quick start</a> page the path is <code>C:\Program Files\Microsoft SQL Server\130\R_SERVER</code></li>
